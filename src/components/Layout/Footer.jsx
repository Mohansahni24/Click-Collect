                             ...
                             <div className="social-icons">
                                <ul>
                                    ...
                                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M20,5V19a1.007,1.007,0,0,1-1,1H15V13.776h2l0.336-2.3H15V9.659a0.912,0.912,0,0,1,1-1.031h1.5V6.55a11.284,11.284,0,0,0-1.641-.109c-2.2,0-3.3,1.219-3.3,3.039v1.992h-2v2.3h2V20H5a1.007,1.007,0,0,1-1-1V5A1.007,1.007,0,0,1,5,4H19A1.007,1.007,0,0,1,20,5Z"></path></svg></li>
                                     ...
                                     <li> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M20,12c0,5.664,0,5.664-8,5.664s-8,0-8-5.664,0-5.664,8-5.664S20,6.333,20,12Zm-5,0L10,9v6Z"></path></svg></li>
                                </ul>
                             </div>
                        </div>
                     </div>
               ...
               <div className="container">
                  <div className="bottom-wrp">
                    <div className="bottom-left">
                          <span class="wt-display-inline-block wt-vertical-align-middle">&nbsp; © 2026 MOHAN &nbsp; | &nbsp; INDIA &nbsp; | &nbsp; English(IND)</span>
                        </div>
...
//                 className="flex-1 px-4 py-2 rounded-l-lg border-0 focus:outline-none text-gray-900"
//               />
...
//                 <span className="bg-white text-gray-900 px-2 py-1 rounded text-sm font-medium">VISA</span>
//                 <span className="bg-white text-gray-900 px-2 py-1 rounded text-sm font-medium">MC</span>
//                 <span className="bg-white text-gray-900 px-2 py-1 rounded text-sm font-medium">AMEX</span>
//                 <span className="bg-white text-gray-900 px-2 py-1 rounded text-sm font-medium">PP</span>
//               </div>
//             </div>
//           </div>
//         </div>
