...
function AllDepartment() {
  const departments = [
    ...
    },
    {
      ...
      link: "/ct/zapatos/cat000774?pmNodeId=11404&prNodeId=11419&regionTelcel=9"
    },
    {
      name: "Women",
      discount: "Up to 40%",
      ...
      link: "/ct/mujeres/cat002202?pmNodeId=11404&prNodeId=11419&regionTelcel=9"
    },
    {
      name: "Men",
      discount: "Up to 40%",
      ...
      link: "/ct/hombres/cat002455?pmNodeId=11404&prNodeId=11419&regionTelcel=9"
    },
    {
      ...
      link: "/ct/hogar-muebles/cat000481?pmNodeId=11404&prNodeId=11419&regionTelcel=9"
    },
    {
      name: "Toyverse",
      discount: "Up to 50%",
      ...
      link: "/ct/juguetes/cat000890?pmNodeId=11404&prNodeId=11419&regionTelcel=9"
    },
            ...
            <div className="glider-track">
              {departments.map((dept, index) => (
                <a 
                  key={index}
                  href={dept.link}
                  className={`department_card  glider-slide `}
                  data-testid="department_card"
                  data-gslide={index}
                >
